...
function HostedView() {
	...
	return (
		<div className="text-center mb-14">
			...
			>
				Private AI that runs on your hardware. Chat, tools, agents, and energy
				profiling &mdash; no cloud required.
			</p>
		...
		<>
			<div className="text-center mb-14">
				...
				<p
					...
					style={{ color: "var(--color-text-secondary)" }}
				>
					Your local AI is ready. Everything runs on your device &mdash; no data
					leaves your machine.
				</p>
				<span
	...
	return (
		<>
			...
			<div className="mb-10">
				...
				>
					...
					<p
						...
						style={{ color: "var(--color-text-tertiary)" }}
					>
						One-click install. Bundles Ollama and the server &mdash; no setup
						required.
					</p>
			...
			<div className="flex flex-col gap-3 mb-10">
				<Section
					icon={Terminal}
					title="Command Line (macOS / Linux)"
					defaultOpen
				>
					<p
						className="text-xs"
				...
				<Section icon={Globe} title="Docker (Cloud / VPS Deploy)">
					...
					<p
						...
						style={{ color: "var(--color-text-tertiary)" }}
					>
						This starts both the API server and Ollama. The web UI is bundled
						and served automatically at port 8000.
					</p>
				</Section>
			</div>
