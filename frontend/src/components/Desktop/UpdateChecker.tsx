...
export function UpdateChecker() {
	...
	// biome-ignore lint/suspicious/noExplicitAny: Tauri Update type is loaded dynamically
	...
	useEffect(() => {
		...
		// biome-ignore lint/suspicious/noExplicitAny: Vite env not typed on raw import.meta
	...
	const handleDownload = useCallback(async () => {
		...
		try {
			...
			// biome-ignore lint/suspicious/noExplicitAny: Tauri download event has no exported type
