			...
			<div style={styles.listPanel}>
				...
				<div style={styles.listScroll}>
					{traces.map((trace) => {
						...
						return (
							// biome-ignore lint/a11y/noStaticElementInteractions: list item with complex styling
							// biome-ignore lint/a11y/useKeyWithClickEvents: complex list item interaction
							<div
								key={trace.id}
								style={{
									...styles.traceItem,
