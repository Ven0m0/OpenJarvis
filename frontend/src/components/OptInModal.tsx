import { Cpu, DollarSign, Lock, Trophy, X, Zap } from "lucide-react";
			...
			>
				...
				<div className="px-8 pt-8 pb-6">
					...
					<div
						...
						style={{
							background:
								"linear-gradient(135deg, var(--color-accent), var(--color-accent-purple))",
						}}
					>
