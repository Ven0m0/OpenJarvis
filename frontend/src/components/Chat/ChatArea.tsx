...
export function ChatArea() {
	...
	const [hasConnectedSources, setHasConnectedSources] = useState<
		boolean | null
	>(null);
			...
			{hasConnectedSources === false && !bannerDismissed && (
				...
				>
					...
					<span style={{ color: "var(--color-text-secondary)", flex: 1 }}>
						Connect your data sources (Gmail, iMessage, Slack, etc.) to get
			...
			>
				{isEmpty ? (
					<div className="flex flex-col items-center justify-center h-full px-4">
						...
						>
							Ask anything. Your AI runs locally — private, fast, and always
							available.
						</p>
									...
									setTimeout(
										() =>
											window.dispatchEvent(
												new CustomEvent("switch-tab", { detail: "messaging" }),
											),
										100,
									);
								}}
					...
					<div className="max-w-[var(--chat-max-width)] mx-auto px-4 py-6">
						...
						{(() => {
							if (!streamState.isStreaming || streamState.content !== "")
								return null;
