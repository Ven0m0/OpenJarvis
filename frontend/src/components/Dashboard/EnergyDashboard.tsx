import { Activity, Gauge, Hash, Thermometer, Zap } from "lucide-react";
	...
	return (
		<div className="hud-panel p-6">
			...
			<div className="grid grid-cols-2 gap-3 mb-4">
				...
				/>
				<StatCard icon={Gauge} label="Thermal" value={thermalStatus.label} />
				<StatCard
					icon={Hash}
					label="Tokens Processed"
					value={formatNumber(
						savings?.total_tokens ?? telemetry?.total_tokens ?? 0,
					)}
				/>
			</div>
